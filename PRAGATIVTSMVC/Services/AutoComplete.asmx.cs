...
{
    /// <summary>
    /// Summary description for AutoCompleteProd
    /// </summary>
    ...
    public class AutoCompleteProd : System.Web.Services.WebService
    {
            ...
            try
            {
                ...
                if (dt_dealer.Rows.Count > 0)
                {
                    ...
                    if (dt_order.Rows.Count > 0)
                    {
                        ...
                        bool status_device = BLL.DeviceInstallation(Cust_Id.ToString(), device_ID, Device_IMEI_NO, device_type, simnumber, Vehicle_No, "3", "Cargo", DealerId.ToString(), orderid.ToString(), CustomerName, Vehimagemodel, "");
                        //update wallet
