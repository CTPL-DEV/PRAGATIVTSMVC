...
namespace PRAGATIVTSMVC.Services
{
    ...
    public class AutoComplete : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "For Save vehicles")]
        public void SaveVehicleInfo(string DistributorName, string DealerName, string CustomerName, string Customer_Email, string Customer_MobileNumber, int CountryId, int StateId, int CityId, string pincode, string Address, int PackageId, string Vehicle_No, string Device_IMEI_NO, string simnumber,int DistributorId, int DealerId)
        {
            ...
            try
            {
                ...
                string db_name = "Aor2T0SveXPKBbMcC7tSjthAI++qzMZOMtkDjeimINYnX23VBtrCYEG2tZkQKsyW/89syeJQD0rfW1Z+Pe4ImmMiLUmwm8Bng6qht1Tr44G1pWVuP1Ndgg==";
                int Cust_Id = 0;
                // int dealerId = 0;
                ...
                dt_dealer = Dal.ExecuteQuery_Prod_for_Test(abc);
                if (dt_dealer.Rows.Count > 0)
                {
                    ...
                    //check customer 
                    DataTable dt_customer = BLL.Get_Customer_for_test(CustomerName, dealer_id);
                    ...
                    else
                    {
                        ...
                        Cust_Id = BLL.UploadCustomers_test(obj_cust, "", dealer_Name, "", "", 3, password);
                        //Insert Client Role
                    ...
                    DataTable dt_order = BLL.SaveOrder_test(obj_orders);
                    ...
                    if (dt_order.Rows.Count > 0)
                    {
                        ...
                        dt_lastrec = BLL.get_Devices_for_Test(_obj_Smvts_Devices);
                        ...
                        bool status_device = BLL.DeviceInstallation_for_test(Cust_Id.ToString(), device_ID, Device_IMEI_NO, "", simnumber, Vehicle_No, "3", "Cargo", DealerId.ToString(), orderid.ToString(), CustomerName,"");
                        //update wallet
        ...
        public static string CreateRandomUsername(int length = 4)
        {
